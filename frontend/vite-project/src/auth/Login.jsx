  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-orange-50 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 left-20 text-blue-400/50"
      >
        <Sparkles size={40} />
      </motion.div>
      <motion.div
        ...
        className="absolute top-32 right-32 text-purple-400/50"
      >
        <Zap size={32} />
      </motion.div>
      <motion.div
        ...
        className="absolute bottom-32 left-32 text-orange-400/50"
      >
        <Shield size={36} />
      </motion.div>
